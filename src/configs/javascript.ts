...
export function composeJavaScriptConfig(options: JavaScriptOptions): OxlintConfig {
  return {
    env: {
      browser: true,
      builtin: true,
...
function javascriptRules(options: JavaScriptOptions): OxlintConfig['rules'] {
  ...
  return {
    ...
    'unused-imports#js/no-unused-imports': isInEditor ? 'off' : 'error',
    'no-unused-vars': 'off',
    'unused-imports#js/no-unused-vars': [
      'warn',
      {
        args: 'after-used',
        argsIgnorePattern: '^_',
...
function javascriptJsPluginRules(): OxlintConfig['rules'] {
  return {
